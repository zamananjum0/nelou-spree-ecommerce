Spree::Chimpy.config do |config|
  ...
  config.key = Rails.application.secrets.mailchimp_api_key
  ...
  config.list_id = Rails.application.secrets.mailchimp_list
