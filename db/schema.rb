...
ActiveRecord::Schema.define(version: 20160608102244) do
  ...
  create_table "nelou_designer_label_translations", force: :cascade do |t|
    t.integer  "designer_label_id"
    t.string   "locale"
    t.datetime "created_at"
  ...
  add_index "nelou_designer_label_translations", ["designer_label_id"], name: "index_c2121fde99a7bf0e698f112be60f6e6a65ad44a8", using: :btree
  add_index "nelou_designer_label_translations", ["locale"], name: "index_nelou_designer_label_translations_on_locale", using: :btree

  create_table "nelou_designer_labels", force: :cascade do |t|
    ...
    t.string   "background_colour",          limit: 7,   default: "#8d93a3", null: false
    t.boolean  "selection",                              default: false,     null: false
    t.boolean  "featured",                               default: false,     null: false
    t.string   "city",                       limit: 255
    t.string   "country",                    limit: 2
    t.boolean  "accepted",                               default: false,     null: false
    t.boolean  "green",                                  default: false,     null: false
    t.string   "vat",                        limit: 50
  ...
  add_index "nelou_designer_labels", ["accepted"], name: "index_nelou_designer_labels_on_accepted", using: :btree
  add_index "nelou_designer_labels", ["active", "accepted"], name: "index_nelou_designer_labels_on_active_and_accepted", using: :btree
  add_index "nelou_designer_labels", ["active", "featured"], name: "index_nelou_designer_labels_on_active_and_featured", using: :btree
  add_index "nelou_designer_labels", ["active", "selection"], name: "index_nelou_designer_labels_on_active_and_selection", using: :btree
  add_index "nelou_designer_labels", ["active"], name: "index_nelou_designer_labels_on_active", using: :btree
  add_index "nelou_designer_labels", ["user_id"], name: "index_nelou_designer_labels_on_user_id", using: :btree

  create_table "nelou_sale_prices", force: :cascade do |t|
    t.integer  "price_id"
  ...
  add_index "nelou_sale_prices", ["price_id", "start_at", "end_at", "enabled"], name: "sale_price_price_start_end_enabled", using: :btree
  add_index "nelou_sale_prices", ["price_id"], name: "index_nelou_sale_prices_on_price_id", using: :btree
  add_index "nelou_sale_prices", ["start_at", "end_at", "enabled"], name: "index_nelou_sale_prices_on_start_at_and_end_at_and_enabled", using: :btree

  create_table "nelou_size_option_value_conversions", id: false, force: :cascade do |t|
    t.integer "size_option_value_id"
    t.integer "alias_id"
  end

  add_index "nelou_size_option_value_conversions", ["alias_id", "size_option_value_id"], name: "size_option_alias_size_option", unique: true, using: :btree
  add_index "nelou_size_option_value_conversions", ["size_option_value_id", "alias_id"], name: "size_option_size_option_alias", unique: true, using: :btree
  ...
  add_index "spree_option_values", ["option_type_id", "type"], name: "index_spree_option_values_on_option_type_id_and_type", using: :btree
  ...
  create_table "spree_variants", force: :cascade do |t|
    ...
    t.integer  "limited_items"
    t.integer  "limited_items_sold",                          default: 0
  end
